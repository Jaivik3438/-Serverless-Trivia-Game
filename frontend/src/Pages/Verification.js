...
const Verification = (props) => {
    ...
    async function getSession() {
      ...
      await currentUser.getSession(async (err, session) => {
        if (err) {
          ...
          // axios.post("https://us-central1-prefab-pixel-391815.cloudfunctions.net/api",{email,name});
          // console.log(email);
  ...
  const validate = (event) => {
    ...
    let answer1ErrorMessage =
      formValues.answer1.value === ""
        ? "Answer is Mandatory"
        : ALPHABET_REGEX.test(formValues.answer1.value)
        ? ""
        : "Answer can contain only alphabets!";
    ...
    let answer2ErrorMessage =
      formValues.answer2.value === ""
        ? "Answer is Mandatory"
        : ALPHABET_REGEX.test(formValues.answer2.value)
        ? ""
        : "Answer can contain only alphabets!";
    ...
    let answer3ErrorMessage =
      formValues.answer3.value === ""
        ? "Answer is Mandatory"
        : ALPHABET_REGEX.test(formValues.answer3.value)
        ? ""
        : "Answer can contain only alphabets!";
              ...
              >
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    fullWidth
                    error={
                      formValues.answer1.errorMessage === "" ? false : true
                    }
                    helperText={formValues.answer1.errorMessage}
                  />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    fullWidth
                    error={
                      formValues.answer2.errorMessage === "" ? false : true
                    }
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    fullWidth
                    error={
                      formValues.answer3.errorMessage === "" ? false : true
                    }
                ...
                <p>
                  {formValues.answer1.value},{formValues.answer2.value},
                  {formValues.answer3.value}
                </p>
                {/* <Grid item xs={4} sm={4} md={4}>
              {
